  ...
  return (
    <div className="w-full flex flex-col gap-8 max-w-[1080px]">
      <div className="flex flex-col rounded-xl bg-zinc-900 overflow-hidden">
        ...
        {isConnected && (
          <div className="flex flex-row items-center justify-between gap-4 p-3 bg-zinc-800 border-t border-zinc-700">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 text-white text-sm font-medium">
                ...
                ></div>
                {isAvatarTalking ? "Avatar is speaking" : "Avatar is listening"}
              </div>
            </div>
